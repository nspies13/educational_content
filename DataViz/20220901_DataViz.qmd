...
![Amazing DataViz\... But we can't read the text.](https://www.edwardtufte.com/tufte/graphics/minard_lg.gif){alt="Good visualizations clearly communicate their full dataset, but have one key message."}
...
![CpG Island Hypermethylation Profile of Human Cancer](images/paste-DDB4A72E.png){alt="CpG Island Hypermethylation Profile of Human Cancer"}
